<?php /*a:5:{s:63:"F:\phpstudy_pro\WWW\jsh\application\admin\view\view\system.html";i:1584760020;s:63:"F:\phpstudy_pro\WWW\jsh\application\admin\view\public\mate.html";i:1584758642;s:65:"F:\phpstudy_pro\WWW\jsh\application\admin\view\public\header.html";i:1584758681;s:63:"F:\phpstudy_pro\WWW\jsh\application\admin\view\public\menu.html";i:1584760844;s:65:"F:\phpstudy_pro\WWW\jsh\application\admin\view\public\footer.html";i:1584668673;}*/ ?>
<head>
    <meta charset="UTF-8">
...
<title>分销商城后台管理系统</title>


<!-- 顶部开始 -->
<div class="container">
    <div class="logo">
        <a href="system.html">X-admin v2.2</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                ...
                <dd>
                    <a href="../login_view/login.html">退出</a></dd>
            </dl>
        </li>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('管理员列表','/view/admin_list')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite></a>
                    </li>
                    <li>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="会员商城">&#xe6b4;</i>
                    <cite>会员商城</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick=xadmin.add_tab('商品管理','/admin/integral/index')>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>商品管理</cite></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick=xadmin.add_tab('添加规格','/admin/integral/addthe')>
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加规格</cite></a>
                            </li>
                            <li>
                                <a onclick=xadmin.add_tab('添加类型','/admin/integral/addtype')>
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加类型</cite></a>
                            </li>
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('订单管理','unicode.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>订单管理</cite></a>
                    </li>
...
<!--<div class="left-nav">-->
    <!--<div id="side-nav">-->
        <!--<ul id="nav">-->
            ...
            <!--<li>-->
                ...
                <!--<ul class="sub-menu">-->
                    <!--<li>-->
                        <!--<a onclick=xadmin.add_tab('商品管理','<?php echo url("/admin/integral/index"); ?>')>-->
                            <!--<i class="iconfont">&#xe6a7;</i>-->
                            <!--<cite>商品管理</cite></a>-->
                        <!--<ul class="sub-menu">-->
                            <!--<li>-->
                                <!--<a onclick=xadmin.add_tab('添加规格','<?php echo url("/admin/integral/addthe"); ?>')>-->
                                    <!--<i class="iconfont">&#xe6a7;</i>-->
                                    <!--<cite>添加规格</cite></a>-->
                            <!--</li>-->
                            <!--<li>-->
                                <!--<a onclick=xadmin.add_tab('添加类型','<?php echo url("/admin/integral/addtype"); ?>')>-->
                                    <!--<i class="iconfont">&#xe6a7;</i>-->
                                    <!--<cite>添加类型</cite></a>-->
                            <!--</li>-->
    ...
    <!--</div>-->
<!--</div>-->
<!--&lt;!&ndash; <div class="x-slide_left"></div> &ndash;&gt;-->
<!--&lt;!&ndash; 左侧菜单结束 &ndash;&gt;-->
<!--&lt;!&ndash; 右侧主体开始 &ndash;&gt;-->
<!--<div class="page-content">-->
    <!--<div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">-->
